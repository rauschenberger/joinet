...
bilasso <- function(y,cutoff,X,npi=101,pi=NULL,nsigma=100,sigma=NULL,nfolds=10,foldid=NULL,type.measure="deviance",logistic=TRUE,...){
  ...
  for(k in seq_len(nfolds)){
    ...
    if(test$sigma|test$pi|test$trial){
      # optimal pred y
